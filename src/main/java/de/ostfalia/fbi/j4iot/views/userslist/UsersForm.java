...
public class UsersForm extends FormLayout {
    ...
    public static abstract class ProjectFormEvent extends ComponentEvent<UsersForm> {
        private final Project project;

        protected ProjectFormEvent(UsersForm source, Project project) {
            super(source, false);
    ...
    public static class SaveEvent extends ProjectFormEvent {
        SaveEvent(UsersForm source, Project project) {
            super(source, project);
        }
    }

    public static class DeleteEvent extends ProjectFormEvent {
        DeleteEvent(UsersForm source, Project project) {
            super(source, project);
        }
    }
